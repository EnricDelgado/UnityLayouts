...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: ConsoleDebugLayout
--- !u!114 &4
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_DrawArea:
      ...
      width: 1463
      height: 934
    m_Scale: {x: 0.76197916, y: 0.7619792}
    m_Translation: {x: 731.5, y: 467.00003}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 1225.7552
    m_MinimalGUI: 1
  m_defaultScale: 0.76197916
  m_LastWindowPixelSize: {x: 1463, y: 955}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
